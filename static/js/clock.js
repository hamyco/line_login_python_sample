...
//    document.getElementById("clock_time").innerHTML = h + ":" + mi + ":" + s;
    document.getElementById("clock_date_time").innerHTML =  y + "/" + mo + "/" + d + "  " +  h + ":" + mi + ":" + s;
...
/*
saveInClipboard () {
    LCS.Interface.writeToClipboard(() => {
      // success
      this.events.trigger('SAVE_IN_COPY_KEEP', 'copy')
    }, () => {}, {text: this.getSharedUrl('copyshare', true)})
};*/

function SaveInClipboard (){
	LCS.Interface.writeToClipboard(function() {
	  // success
	}, function() {
	  // error (ex: permission error)
